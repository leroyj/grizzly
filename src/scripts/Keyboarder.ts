...
export class Keyboarder {
    ...
    constructor () {
      window.addEventListener("keydown",this.keyDownHandle.bind(this) , true);
      /* key up*/
      window.addEventListener("keyup", this.keyUpHandle.bind(this), true);
    }
    ...
    destructor () {
      ...
      /* key up*/
      window.removeEventListener("keyup", this.keyUpHandle, true);
    }
